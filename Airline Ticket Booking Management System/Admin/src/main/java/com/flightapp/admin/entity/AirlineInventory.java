...
public class AirlineInventory {
	...
	public AirlineInventory(int id, Integer inventoryId, Integer airline_id, String airlineName, String fromPlace,
			String toPlace, LocalDateTime startDateTime, LocalDateTime endDateTime, Integer scheduleDays,
